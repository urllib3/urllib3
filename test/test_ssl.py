...
class TestSSL:
    ...
    def test_is_ipaddress_true(self, addr: typing.Union[bytes, str]) -> None:
    ...
    def test_is_ipaddress_false(self, addr: typing.Union[bytes, str]) -> None:
    ...
    def test_create_urllib3_context_pha(
        ...
        pha: typing.Optional[bool],
        expected_pha: typing.Optional[bool],
    ) -> None:
        context = mock.create_autospec(ssl_.SSLContext)
        context.set_ciphers = mock.Mock()
        context.options = 0
