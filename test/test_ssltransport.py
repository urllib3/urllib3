...
def sample_request(binary: bool = True) -> typing.Union[bytes, str]:
    request = (
...
@typing.overload
def sample_response(binary: bool = ...) -> typing.Union[bytes, str]:
    ...


def sample_response(binary: bool = True) -> typing.Union[bytes, str]:
    response = b"HTTP/1.1 200 OK\r\nContent-Length: 0\r\n\r\n"
    return response if binary else response.decode("utf-8")


def validate_response(
    provided_response: typing.Union[bytes, bytearray, str], binary: bool = True
) -> None:
...
class SingleTLSLayerTestCase(SocketDummyServerTestCase):
    ...
    def start_dummy_server(
        self, handler: typing.Optional[typing.Callable[[socket.socket], None]] = None
    ) -> None:
