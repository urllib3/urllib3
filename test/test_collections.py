...
class TestHTTPHeaderDict:
    ...
    def test_extend_from_bytes_dict(self, d: HTTPHeaderDict) -> None:
    ...
    def test_contains_with_bytes(self, d: HTTPHeaderDict) -> None:
        d["Content-Type"] = "application/json"
        content_type_header: object = b"Content-Type"
        missing_header: object = b"X-Not-There"
        assert content_type_header in d
        assert missing_header not in d
