...
In order to setup the development environment, you'll need `nox <https://nox.thea.codes/en/stable/index.html>`_ and `mypy <http://mypy-lang.org>`_ installed in your machine::

  $ pip install --user --upgrade nox mypy
