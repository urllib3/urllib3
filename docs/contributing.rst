...
In order to do this follow this `link <https://github.com/urllib3/urllib3/compare/BASE...release-VERSION?expand=1&template=release.md>`_ and fill the template.