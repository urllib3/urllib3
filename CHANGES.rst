...
- Allowed passing negative integers as ``amt`` to read methods of :class:`http.client.HTTPResponse` as an alternative to ``None``. (`#3122 <https://github.com/urllib3/urllib3/issues/3122>`__)
