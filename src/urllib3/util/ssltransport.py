...
class SSLTransport:
    ...
    ) -> typing.Union[typing.BinaryIO, typing.TextIO, socket.SocketIO]:
        """
    ...
    ) -> typing.Optional["_TYPE_PEER_CERT_RET_DICT"]:
        ...

    @typing.overload
    def getpeercert(self, binary_form: "Literal[True]") -> typing.Optional[bytes]:
        ...
    ...
    def settimeout(self, value: typing.Optional[float]) -> None:
    ...
    def _wrap_ssl_read(
        self, len: int, buffer: typing.Optional[bytearray] = None
    ...
    def _ssl_io_loop(
        self,
        func: typing.Callable[[int, typing.Optional[bytearray]], bytes],
        arg1: int,
        arg2: typing.Optional[bytearray],
    ) -> bytes:
        ...
    ...
    def _ssl_io_loop(
        ...
        arg1: typing.Union[None, bytes, int] = None,
        arg2: typing.Optional[bytearray] = None,
    ) -> _ReturnValue:
