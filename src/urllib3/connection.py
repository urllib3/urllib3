...
class HTTPConnection(_HTTPConnection):
    ...
    def _tunnel(self) -> None:
        # backport from
        # https://github.com/python/cpython/blob/87223f32aba872cfebde6fbe38673799eb79f248/Lib/http/client.py#L929-L963
        _MAXLINE = http.client._MAXLINE  # type: ignore[attr-defined]
        connect = b"CONNECT %s:%d %s\r\n" % (  # type: ignore[str-format]
            self._tunnel_host.encode("idna"),  # type: ignore[union-attr]
            self._tunnel_port,
