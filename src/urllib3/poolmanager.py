...
_CONN_CLS_ACCEPTS_BLOCKSIZE = sys.version_info >= (3, 7)
if _CONN_CLS_ACCEPTS_BLOCKSIZE:
...
def _default_key_normalizer(key_class, request_context):
    ...
    if _CONN_CLS_ACCEPTS_BLOCKSIZE and context.get("key_blocksize") is None:
...
class PoolManager(RequestMethods):
    ...
    def _new_pool(self, scheme, host, port, request_context=None):
        ...
        elif _CONN_CLS_ACCEPTS_BLOCKSIZE:
            request_context = request_context.copy()

        # Default blocksize to 16384 if missing from the context
        if _CONN_CLS_ACCEPTS_BLOCKSIZE and request_context.get("blocksize") is None:
